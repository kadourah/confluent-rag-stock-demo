 ...
 */
export declare abstract class Aead {
    /**
     ...
     *
     */
    abstract encrypt(plaintext: Uint8Array, opt_associatedData?: Uint8Array | null): Promise<Uint8Array>;
    /**
     ...
     */
    abstract decrypt(ciphertext: Uint8Array, opt_associatedData?: Uint8Array | null): Promise<Uint8Array>;
}
